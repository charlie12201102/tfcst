...
def main():
    ...
    parser.add_argument('--img_path', default='./test_images/list_img/Misc_95/',help='Path to images')
    ...
    #网络模型——FCST
    model = FCOSDetector(mode="inference", config=DefaultConfig)
    ...
    #加载权重
    model.load_state_dict(torch.load(opt.model_path, map_location=torch.device('cuda')))
