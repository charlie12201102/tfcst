...
class ClsRegIouHead(nn.Module):
    def __init__(self, in_channel, class_num, GN=True, prior=0.01):

        super(ClsRegIouHead, self).__init__()
        self.prior = prior
        ...
        # added by WSK
        self.iou_pred = nn.Conv2d(in_channel, 1, 3, padding=1)
    ...
    def forward(self, inputs):
        ...
        for index, P in enumerate(inputs):
            ...
            iou_preds.append(self.iou_pred(reg_conv_out))
